...
<body class="bg-slate-500">
    <div class="flex items-center justify-center p-4">
        <div class="w-full max-w-3xl bg-white shadow-lg rounded-xl">
            <div class="flex flex-col md:flex-row">
                <div class="flex items-center justify-center p-4 md:w-1/3">
                    <img src="../image/pp.jpeg" alt="foto profile" class="w-24 h-24 rounded-full md:w-32 md:h-32">
                </div>
                <div class="flex flex-col items-center justify-center p-4 md:w-2/3 rounded-r-xl">
                    <h1 class="text-xl font-bold text-center md:text-left" style="font-family:'intro-black';";><?=  $identitas[0] ?></h1>
                    <p class="text-sm text-center md:text-left" style="font-family:'intro-bold';"><?=   $identitas[2] ?></p>
                </div>
            </div>
            <div class="flex flex-col md:flex-row">
                <div class="p-4 md:w-1/2">
                    <div class="mb-4">
                        <h1 class="font-bold" style="font-family: 'intro-bold';"><?= $main[0] ?></h1>
                        <p style="font-family: 'intro-light';">
                    ...
                    <div>
                        <div>
                            <h1 class="font-bold" style="font-family: 'intro-bold';"><?= $main[1] ?></h1>
                            <ul class="ml-5 list-disc" style="font-family: 'intro-light';">
                ...
                <div class="p-4 md:w-1/2">
                    ...
                    <div>
                        <h1 class="font-bold" style="font-family: 'intro-bold';"><?= $main[6] ?></h1>
                        <ul class="ml-5 list-disc" style="font-family: 'intro-light';">
            ...
            <div class="p-4 md:flex md:flex-row md:gap-10">
                <div class="flex items-center gap-2 mb-2">
                    ...
                    <div>
                        <h1 class="font-bold" style="font-family: 'intro-bold';"><?= $main[2] ?></h1>
                        <p style="font-family: 'intro-light';"><?= $identitas[3] ?></p>
                    </div>
                </div>
                <div class="flex items-center gap-2 mb-2">
                    <div class="mr-2">
                    ...
                    <div>
                        <h1 class="font-bold" style="font-family: 'intro-bold';"><?= $main[3] ?></h1>
                        <p style="font-family: 'intro-light';"><?= $identitas[1] ?></p>
                    </div>
                </div>
                <div class="flex items-center gap-3 mb-2">
                    <div class="mr-2">
                        <img src="../image/email.png" alt="logo" class="w-6 h-6 scale-150">
                    </div>
                    <div>
                        <h1 class="font-bold" style="font-family: 'intro-bold';"><?= $main[4] ?></h1>
                        <p style="font-family: 'intro-light';"><?= $identitas[4] ?></p>
                    </div>
                </div>
            </div>
        </div>
